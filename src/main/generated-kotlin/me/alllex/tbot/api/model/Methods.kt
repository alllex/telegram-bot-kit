...
suspend fun TelegramBotApiClient.sendMessage(
    ...
    trySendMessage(SendMessageRequest(chatId, text, businessConnectionId, messageThreadId, parseMode, entities, linkPreviewOptions, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.copyMessage(
    ...
    tryCopyMessage(CopyMessageRequest(chatId, fromChatId, messageId, messageThreadId, caption, parseMode, captionEntities, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendPhoto(
    ...
    trySendPhoto(SendPhotoRequest(chatId, photo, businessConnectionId, messageThreadId, caption, parseMode, captionEntities, hasSpoiler, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendAudio(
    ...
    trySendAudio(SendAudioRequest(chatId, audio, businessConnectionId, messageThreadId, caption, parseMode, captionEntities, duration, performer, title, thumbnail, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendDocument(
    ...
    trySendDocument(SendDocumentRequest(chatId, document, businessConnectionId, messageThreadId, thumbnail, caption, parseMode, captionEntities, disableContentTypeDetection, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendVideo(
    ...
    trySendVideo(SendVideoRequest(chatId, video, businessConnectionId, messageThreadId, duration, width, height, thumbnail, caption, parseMode, captionEntities, hasSpoiler, supportsStreaming, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendAnimation(
    ...
    trySendAnimation(SendAnimationRequest(chatId, animation, businessConnectionId, messageThreadId, duration, width, height, thumbnail, caption, parseMode, captionEntities, hasSpoiler, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendVoice(
    ...
    trySendVoice(SendVoiceRequest(chatId, voice, businessConnectionId, messageThreadId, caption, parseMode, captionEntities, duration, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendVideoNote(
    ...
    trySendVideoNote(SendVideoNoteRequest(chatId, videoNote, businessConnectionId, messageThreadId, duration, length, thumbnail, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendMediaGroup(
    ...
    trySendMediaGroup(SendMediaGroupRequest(chatId, media, businessConnectionId, messageThreadId, disableNotification, protectContent, replyParameters)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendLocation(
    ...
    trySendLocation(SendLocationRequest(chatId, latitude, longitude, businessConnectionId, messageThreadId, horizontalAccuracy, livePeriod, heading, proximityAlertRadius, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendVenue(
    ...
    trySendVenue(SendVenueRequest(chatId, latitude, longitude, title, address, businessConnectionId, messageThreadId, foursquareId, foursquareType, googlePlaceId, googlePlaceType, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendContact(
    ...
    trySendContact(SendContactRequest(chatId, phoneNumber, firstName, businessConnectionId, messageThreadId, lastName, vcard, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendDice(
    ...
    trySendDice(SendDiceRequest(chatId, businessConnectionId, messageThreadId, emoji, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendSticker(
    ...
    trySendSticker(SendStickerRequest(chatId, sticker, businessConnectionId, messageThreadId, emoji, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
...
suspend fun TelegramBotApiClient.sendGame(
    ...
    trySendGame(SendGameRequest(chatId, gameShortName, businessConnectionId, messageThreadId, disableNotification, protectContent, replyParameters, replyMarkup)).getResultOrThrow()
